...
/* -----------------------------------------------------------------------------------------
   $Id: advanced_search.php 12098 2019-09-19 10:58:32Z GTB $
...
$smarty->assign('INPUT_KEYWORDS', xtc_draw_input_field('keywords', '', 'placeholder="' . IMAGE_BUTTON_SEARCH . '" style="width: 100%"'));
