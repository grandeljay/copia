...
define('MODULE_SHIPPING_UPSE_COUNTRIES_1_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 1 (Enter WORLD for the rest of the world.):');
...
define('MODULE_SHIPPING_UPSE_COUNTRIES_2_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 2 (Enter WORLD for the rest of the world.):');
...
define('MODULE_SHIPPING_UPSE_COUNTRIES_3_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 3 (Enter WORLD for the rest of the world.):');
...
define('MODULE_SHIPPING_UPSE_COUNTRIES_4_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 4 (Enter WORLD for the rest of the world.):');
...
define('MODULE_SHIPPING_UPSE_COUNTRIES_5_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 41 (Enter WORLD for the rest of the world.):');
...
define('MODULE_SHIPPING_UPSE_COUNTRIES_7_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 5 (Enter WORLD for the rest of the world.):');
...
define('MODULE_SHIPPING_UPSE_COUNTRIES_8_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 6 (Enter WORLD for the rest of the world.):');
...
define('MODULE_SHIPPING_UPSE_COUNTRIES_9_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 7 (Enter WORLD for the rest of the world.):');
...
define('MODULE_SHIPPING_UPSE_COUNTRIES_10_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 8 (Enter WORLD for the rest of the world.):');
...
define('MODULE_SHIPPING_UPSE_COUNTRIES_11_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 9 (Enter WORLD for the rest of the world.):');
...
define('MODULE_SHIPPING_UPSE_COUNTRIES_12_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 10 (Enter WORLD for the rest of the world.):');
...
define('MODULE_SHIPPING_UPSE_COUNTRIES_13_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 11 (Enter WORLD for the rest of the world.):');
...
define('MODULE_SHIPPING_UPSE_COUNTRIES_14_DESC' , 'Durch Komma getrennte ISO-K&uuml;rzel der Staaten f&uuml;r Zone 12 (Enter WORLD for the rest of the world.):');
