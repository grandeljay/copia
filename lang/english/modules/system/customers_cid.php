...
define('MODULE_CUSTOMERS_CID_NEXT_DESC', 'This number is used next');
define('MODULE_CUSTOMERS_CID_FORMAT_TITLE', 'customer number format');
define('MODULE_CUSTOMERS_CID_FORMAT_DESC', 'Construction scheme: {n}=current number, {d}=day, {m}=month, {y}=year, <br>"KD{n}-{d}-{m}-{y}" gets "KD99-28-02-2007"');
