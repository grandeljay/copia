...
define('MODULE_PAYMENT_BILLPAYDEBIT_MERCHANT_ID_DESC' , MODULE_PAYMENT_BILLPAY_DATA_PROVIDED_BY_BILLPAY);
...
# only this payment
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_TITLE', 'BillPay - Direct Debit');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_DESCRIPTION', 'BillPay - Direct Debit');


define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO1', 'Thank you for choosing to pay by direct debit with BillPay. We will charge the amount due in the next few days.');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO2', 'Order was issued by ');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO3', '');

define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO1', 'Direct debit fee for this order is ');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO2', '');

// Plugin 1.7
define('MODULE_PAYMENT_BILLPAYDEBIT_THANK_YOU_TEXT', 'Thank you for choosing BillPay Direct Debit when making your purchase.');
define('MODULE_PAYMENT_BILLPAYDEBIT_PAY_UNTIL_TEXT', 'We will debit %1$s %2$s from the following account within the next few days:');
define('MODULE_PAYMENT_BILLPAYDEBIT_EMAIL_TEXT', 'BillPay will inform you in advance by e-mail of the date on which your account will be debited.');
