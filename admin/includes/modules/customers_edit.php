...
<div class="div_box mrg5">
    <div class="customers-groups">
        <div class="flt-l">
            <?php
            if ('' != $customers_statuses_id_array[$cInfo->customers_status]['csa_image']) {
                echo xtc_image(DIR_WS_CATALOG . DIR_WS_ICONS . $customers_statuses_id_array[$cInfo->customers_status]['csa_image'], '');
            }
            ?>
        </div>

        <div class="main" style="margin:12px 0;">
            <?php echo '<b>' . HEADING_TITLE_STATUS  . ':</b> ' . $customers_statuses_id_array[$cInfo->customers_status]['text'] ; ?>
        </div>
    </div>
    ...
    <?php
    echo xtc_draw_form('customers', FILENAME_CUSTOMERS, xtc_get_all_get_params(array('action')) . 'action=update', 'post')
    ...
    <div class="formAreaC">
        ...
        <?php if ($cInfo->customers_default_address_id == $cInfo->address_book_id) { ?>
            <div class="formAreaTitle"><span class="title"><?php echo CATEGORY_CONTACT; ?></span></div>
        <?php } ?>

        <?php $style = ($cInfo->customers_default_address_id != $cInfo->address_book_id) ? ' style="display:none;"' : ''; ?>
            ...
            <div class="formAreaC">
                <table class="tableConfig borderall">
                    <tr>
                        ...
                        <td class="dataTableConfig col-single-right">
                            <?php echo xtc_cfg_checkbox_unallowed_module('payment', 'payment_unallowed', $cInfo->payment_unallowed); ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="dataTableConfig col-single-right">
                            <?php echo xtc_cfg_checkbox_unallowed_module('shipping', 'shipping_unallowed', $cInfo->shipping_unallowed); ?>
                        </td>
                    </tr>
                    ...
                    <tr><?php include DIR_WS_MODULES . FILENAME_CUSTOMER_MEMO; ?></tr>
                </table>
            </div>
        <?php } ?>

        <div class="main mrg5">
            <input type="submit" class="button" onclick="this.blur();" value="<?php echo BUTTON_UPDATE; ?>">

            <?php echo ' <a class="button" onclick="this.blur();" href="' . xtc_href_link(FILENAME_CUSTOMERS, xtc_get_all_get_params(array('action', 'edit'))) . '">' . BUTTON_CANCEL . '</a>'; ?>
        </div>
