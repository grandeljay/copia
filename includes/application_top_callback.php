...
foreach (auto_include(DIR_FS_CATALOG . 'includes/extra/application_top_callback/application_top_callback_begin/', 'php') as $file) {
    require($file);
}
...
foreach (auto_include(DIR_FS_CATALOG . 'includes/extra/application_top_callback/application_top_callback_end/', 'php') as $file) {
    require($file);
}
