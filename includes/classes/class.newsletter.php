    ...
    function sendRequestMail($mail, $action = 'opt_in')
    {
        ...
        switch ($action) {
            case 'opt_in':
                ...
                foreach (auto_include(DIR_FS_CATALOG . 'includes/extra/newsletter/opt_in/', 'php') as $file) {
                    require_once($file);
                }
                break;

            case 'unsubscribe':
                foreach (auto_include(DIR_FS_CATALOG . 'includes/extra/newsletter/unsubscribe/', 'php') as $file) {
                    require_once($file);
                }
                break;
            ...
            case 'subscribe':
                if (ACTIVATE_GIFT_SYSTEM == 'true') {
                    if (
                        defined('MODULE_NEWSLETTER_VOUCHER_AMOUNT')
                    ...
                    if (
                        defined('MODULE_NEWSLETTER_DISCOUNT_COUPON')
                ...
                foreach (auto_include(DIR_FS_CATALOG . 'includes/extra/newsletter/subscribe/', 'php') as $file) {
                    require_once($file);
                }
                break;
        }
