<?php
/* -----------------------------------------------------------------------------------------
   $Id: shopgate_xtc_php_mail.inc.php 3072 2012-06-18 15:01:13Z hhacker $
   ...
   (c) 2006 XT-Commerce (shopgate_xtc_php_mail.inc.php)

   Released under the GNU General Public License
   ---------------------------------------------------------------------------------------*/
// include the mail classes

function shopgate_php_mail($from_email_address, $from_email_name,
...
function _check_attachments($attachments, $path_to_attachments)
{
