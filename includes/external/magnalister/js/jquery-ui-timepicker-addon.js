	...
	$.extend(Timepicker.prototype, {
		...
		*/
		_onTimeChange: function() {
			...
			if (hasChanged) {
				window.dthack = this;
				// magnalister: bugfix: Set the current year so $.datepicker._getDate(this.inst) returns a value for the date.
				if (this.inst.currentYear == 0) {
					this.inst.currentDay = this.inst.selectedDay;
					this.inst.currentMonth = this.inst.selectedMonth;
					this.inst.currentYear = this.inst.selectedYear;
				}
