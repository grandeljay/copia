...
/////////////////////////////////////////////
    ...
    protected function DrawLegend()
    {
        ...
        foreach ($this->legend as $leg) {
            ...
            $this->DrawText($font, 0, $x_pos, $y_pos - 1, $this->ndx_text_color, $leg, $text_align, 'bottom');
            if ($draw_colorbox) {
                ...
                if (isset($this->ndx_data_border_colors[$color_index])) {
                	$borderColor = $this->ndx_data_border_colors[$color_index];
                } else {
                	$borderColor = $this->ndx_text_color;
                }
