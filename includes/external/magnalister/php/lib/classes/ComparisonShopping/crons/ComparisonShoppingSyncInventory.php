...
class ComparisonShoppingSyncInventory extends MagnaCompatibleSyncInventory {
	protected function getBaseRequest() {
		$r = parent::getBaseRequest();
		$r['SEARCHENGINE'] = $r['SUBSYSTEM'];
		$r['SUBSYSTEM'] = 'ComparisonShopping';
		return $r;
	}
}
