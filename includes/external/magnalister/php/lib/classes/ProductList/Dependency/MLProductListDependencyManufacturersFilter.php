...
class MLProductListDependencyManufacturersFilter extends MLProductListDependency {

	public function manipulateQuery() {
		$aManufacturers = getDBConfigValue(
			$this->getMagnaSession('currentPlatform').'.filter.manufacturer',
