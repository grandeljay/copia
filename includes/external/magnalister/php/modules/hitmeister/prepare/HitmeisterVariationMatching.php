...
class HitmeisterVariationMatching extends VariationMatching
{
    protected function getAttributesMatchingHelper()
    {
        return HitmeisterHelper::gi();
    }

    protected function getTopTenCategoriesHandler()
    {
        return new HitmeisterTopTenCategories();
    }

    protected function getCategoryMatchingHandler()
    {
        return new HitmeisterCategoryMatching();
    }
}
