...
class GoogleshoppingPrepareProductList extends MLProductList {
    public function __construct() {
        ...
        $this
            ->addDependency('MLProductListDependencyGoogleshoppingPrepareFormAction', array('selectionname' => $this->getSelectionName()))
