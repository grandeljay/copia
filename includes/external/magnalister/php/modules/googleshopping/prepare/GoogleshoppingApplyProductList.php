...
class GoogleshoppingApplyProductList extends MLProductListGoogleshoppingAbstract {
    public function __construct() {
        ...
        parent::__construct();
        $this
            ->addDependency('MLProductListDependencyGoogleshoppingApplyFormAction', array('selectionname' => $this->getSelectionName()))
    ...
    protected function buildQuery() {
        ...
        $googleProperties = MagnaDB::gi()->fetchArray("
        ...
        parent::buildQuery()->oQuery->where(
            "p.".$sKeyType." NOT IN ('".implode('\' , \'', $googleProperties)."')
		"
        );
        return $this;
    }
