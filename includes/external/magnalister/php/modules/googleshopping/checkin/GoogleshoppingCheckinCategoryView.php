...
class GoogleshoppingCheckinCategoryView extends SimpleCheckinCategoryView {
    public function __construct($cPath = 0, $settings = array(), $sorting = false, $search = '') {
        ...
        if (!isset($_GET['kind']) || ($_GET['kind'] != 'ajax')) {
            $this->simplePrice->setCurrency(getDBConfigValue('googleshopping.currency', $this->_magnasession['mpID']));
        }
    }
}
