...
class MLProductListDependencyGoogleshoppingPrepareFormAction extends MLProductListDependency {
    public function getActionBottomLeftTemplate() {
        return 'googleshoppingprepareformleft';
    }

    public function getActionBottomRightTemplate() {
        return 'googleshoppingprepareformright';
    }
