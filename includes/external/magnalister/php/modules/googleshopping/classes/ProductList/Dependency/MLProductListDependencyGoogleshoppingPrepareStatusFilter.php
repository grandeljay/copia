...
class MLProductListDependencyGoogleshoppingPrepareStatusFilter extends MLProductListDependencyPrepareStatusFilter {
    ...
    protected function getPrepareTable() {
        return TABLE_MAGNA_GOOGLESHOPPING_PREPARE;
    }
}
