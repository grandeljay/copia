...
defined('TABLE_MAGNA_CDISCOUNT_VARIANTMATCHING') OR define('TABLE_MAGNA_CDISCOUNT_VARIANTMATCHING', 'magnalister_cdiscount_variantmatching');
...
class CdiscountVariationMatching extends VariationMatching
{
    protected function getAttributesMatchingHelper()
    {
        return CdiscountHelper::gi();
    }

    protected function getTopTenCategoriesHandler()
    {
        return new CdiscountTopTenCategories();
    }

    protected function getCategoryMatchingHandler()
    {
        return new CdiscountCategoryMatching();
    }
}
