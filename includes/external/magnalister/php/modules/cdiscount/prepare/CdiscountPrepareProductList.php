...
class CdiscountPrepareProductList extends MLProductList {
	...
	public function __construct() {
		...
		$this
			->addDependency('MLProductListDependencyCdiscountPrepareFormAction', array('selectionname' => $this->getSelectionName()))
