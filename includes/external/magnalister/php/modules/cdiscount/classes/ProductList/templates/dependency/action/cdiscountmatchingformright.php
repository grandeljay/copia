...
<div id="manMatchInfo" class="dialog2" title="<?php echo ML_LABEL_INFORMATION.' '.ML_AMAZON_LABEL_MANUAL_MATCHING; ?>"><?php echo ML_CDISCOUNT_TEXT_MANUALLY_MATCHING_DESC; ?></div>
<div id="autoMatchInfo" class="dialog2" title="<?php echo ML_LABEL_INFORMATION.' '.ML_AMAZON_LABEL_AUTOMATIC_MATCHING; ?>"><?php echo ML_CDISCOUNT_TEXT_AUTOMATIC_MATCHING_DESC; ?></div>
<div id="confirmDiag" class="dialog2" title="<?php echo ML_LABEL_NOTE; ?>"><?php echo ML_CDISCOUNT_TEXT_AUTOMATIC_MATCHING_CONFIRM; ?></div>
