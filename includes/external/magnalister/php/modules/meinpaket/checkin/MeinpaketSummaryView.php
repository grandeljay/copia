 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: MeinpaketSummaryView.php 6119 2015-10-19 14:20:21Z masoud.khodaparast $
 *
	...
	protected function getAdditionalItemCells($key, $dbRow) {
		...
		return '
				<td><table class="nostyle"><tbody>
						<tr><td>'.ML_LABEL_NEW.':&nbsp;</td><td>'.$this->simplePrice->setPrice($this->selection[$dbRow['products_id']]['price'])->getPrice().'							       
