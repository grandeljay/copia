...
class MLProductListDependencyMeinpaketPrepareFormAction extends MLProductListDependency {
	public function getActionBottomLeftTemplate(){
		return 'meinpaketprepareformleft';
	}
	
	public function getActionBottomRightTemplate(){
		return 'meinpaketprepareformright';
	}
...
//		);
//		if (!empty($pIDs)) {	
//			require_once(DIR_MAGNALISTER_MODULES . 'magnacompatible/classes/HoodProductSaver.php');
