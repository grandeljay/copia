...
abstract class MLProductListEtsyAbstract extends MLProductList {
	...
	protected function getEtsyPrice($aRow) {
	...
	protected function getQuantityForEtsy($aRow) {
		return EtsyHelper::getQuantityForEtsy($aRow['products_quantity'], $this->aMagnaSession['mpID']);
	}
}
