...
Copied from Hood + extended. Most functions to be dropped after ensuring thjey're not used

*/
class EtsyApiConfigValues extends MagnaCompatibleApiConfigValues {
	...
	public function getVariantConfigurationDefinition($category, $secondaryCategory = null) {
		$requestParams = array(
			'DATA' => array(
				'CategoryID' => $category,
				'Language'   => getDBConfigValue('etsy.shop.language', $this->mpId, 'en')
			)
		);
	 ...
	 * @deprecated
	 */
	public function getEtsyPaymentOptions() {
