 ...
 * -----------------------------------------------------------------------------
 */
require_once(DIR_MAGNALISTER_MODULES.'bepado/classes/MLProductListBepadoAbstract.php');

class BepadoPrepareProductList extends MLProductListBepadoAbstract {
	...
	public function __construct() {
		...
		parent::__construct();
		$this
			->addDependency('MLProductListDependencyBepadoPrepareFormAction', array('selectionname' => $this->getSelectionName()))
			->addDependency('MLProductListDependencyBepadoPrepareStatusFilter')
