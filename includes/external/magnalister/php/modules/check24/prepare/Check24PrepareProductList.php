 ...
 * -----------------------------------------------------------------------------
 */
require_once(DIR_MAGNALISTER_MODULES.'check24/classes/MLProductListCheck24Abstract.php');

class Check24PrepareProductList extends MLProductListCheck24Abstract {
	...
	public function __construct() {
		...
		parent::__construct();
		$this
			->addDependency('MLProductListDependencyCheck24PrepareFormAction', array('selectionname' => $this->getSelectionName()))
			->addDependency('MLProductListDependencyCheck24PrepareStatusFilter')
