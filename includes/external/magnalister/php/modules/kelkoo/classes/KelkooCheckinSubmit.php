...
class KelkooCheckinSubmit extends ComparisonShoppingCheckinSubmit {
	...
	public function getcategoriesname($pID) {
		...
		// Maximale Kategorientiefe, bis zu der der Name der Ueberkategorie geholt wird. Kein von Kelkoo vorgegebener Wert, kann nach
		// persoenlichem Ermessen geaendert werden (aber nicht weglassen wg. moeglichem infinite loop!)
		$maxcatlevel = 4;

		$lang = (string)getDBConfigValue('kelkoo.lang', $this->mpID, 2);
