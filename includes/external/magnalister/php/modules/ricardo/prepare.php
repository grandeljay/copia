...
class RicardoPrepare extends MagnaCompatibleBase {
	...
	protected function saveMatching() {
		...
		require_once(DIR_MAGNALISTER_MODULES . 'ricardo/checkin/RicardoCheckinSubmit.php');

		$itemDetails = $_POST;
		unset($itemDetails['savePrepareData']);

		$oProductSaver = new RicardoProductSaver($this->resources['session']);
