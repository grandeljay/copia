...
class RicardoCheckin extends MagnaCompatibleCheckin {
	public function process() {
		require_once(DIR_MAGNALISTER_MODULES.'ricardo/checkin/RicardoCheckinManager.php');
