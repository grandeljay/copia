...
<form action="<?php echo $this->getUrl(false, false, false); ?>" method="post">
	...
	<input type="submit" name="action[<?php echo $oObject->getIdent(); ?>][resetDescription]" id="reset_description" value="<?php echo ML_GENERIC_BUTTON_RESET_DESCRIPTION; ?>" class="ml-button">
</form>
