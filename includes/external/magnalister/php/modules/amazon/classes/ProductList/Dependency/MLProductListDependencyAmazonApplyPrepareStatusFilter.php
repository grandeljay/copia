...
class MLProductListDependencyAmazonApplyPrepareStatusFilter extends MLProductListDependencyPrepareStatusFilter {

	protected function getPrepareCondition() {
		return array(
			'failed' => " AND is_incomplete = 'true'",
			'prepared' => " AND is_incomplete = 'false'",
			'notprepared' => ""
		);
	}
