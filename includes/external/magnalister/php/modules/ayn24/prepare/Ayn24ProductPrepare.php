 ...
 * -----------------------------------------------------------------------------
 */
require_once(DIR_MAGNALISTER_MODULES.'ayn24/prepare/Ayn24ProductPrepareSaver.php');

class Ayn24ProductPrepare {
	...
	public function __construct(&$resources) {
		...
		$this->saver = new Ayn24ProductPrepareSaver($this->resources, $this->prepareSettings);
	}
	...
	protected function execPreparationView() {
		require_once(DIR_MAGNALISTER_MODULES.'ayn24/prepare/Ayn24ProductPrepareView.php');
		
		$cMDiag = new Ayn24ProductPrepareView($this->resources);
		if ($this->isAjax) {
	...
	protected function execSelectionView() {
		require_once(DIR_MAGNALISTER_MODULES.'ayn24/prepare/Ayn24PrepareCategoryView.php');
		$pV = new Ayn24PrepareCategoryView(
			null,
	...
	protected function processProductList() {
		require_once(DIR_MAGNALISTER_MODULES.'ayn24/prepare/Ayn24PrepareProductList.php');
		$o = new Ayn24PrepareProductList();
		echo  $o;
	}
