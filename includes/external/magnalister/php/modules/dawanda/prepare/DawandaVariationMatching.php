...
defined('TABLE_MAGNA_DAWANDA_VARIANTMATCHING') OR define('TABLE_MAGNA_DAWANDA_VARIANTMATCHING', 'magnalister_dawanda_variantmatching');
...
class DawandaVariationMatching extends VariationMatching
{
    protected function getAttributesMatchingHelper()
    {
        return DawandaHelper::gi();
    }

    protected function getTopTenCategoriesHandler()
    {
        return new DawandaTopTenCategories();
    }

    protected function getCategoryMatchingHandler()
    {
        return new DawandaCategoryMatching();
    }
}
