...
class TradoriaApplyProductList extends MLProductListTradoriaAbstract {
	...
	public function __construct() {
		...
		parent::__construct();
		$this
			->addDependency('MLProductListDependencyTradoriaApplyFormAction', array('selectionname' => $this->getSelectionName()))
