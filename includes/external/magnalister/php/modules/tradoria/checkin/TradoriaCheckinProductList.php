...
class TradoriaCheckinProductList extends MLProductListMagnaCompatibleAbstract{
	...
	public function __construct() {
		...
		$this->aListConfig[] = array(
			...
			'field' => array('tradoriapreparetype'),
		);
		parent::__construct();
		$this
			...
			->addDependency('MLProductListDependencyLastPreparedFilter', array(
				'propertiestablename' => TABLE_MAGNA_TRADORIA_PREPARE, 
