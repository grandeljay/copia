...
class MetroShippingDetailsProcessor {
    private $args = array();
    private $savedvalue = '';
    private $mainKey = '';
    ...
    public function renderView($settings = array()) {
        if ($this->args['international']) {
            $services = MetroApiConfigValues::gi()->getShippingServicesListInternational();
            $locations = MetroApiConfigValues::gi()->getShippingLocationsList();
            ...
            $services = MetroApiConfigValues::gi()->getShippingLocationsListLocal();
            $locations = array();
            $settings = array_merge(
                array(
                    'Service' => '',
                ...
                $('#<?php echo $idkey; ?> input.ml-button.plus').click(function () {
                    ...
                    jQuery.ajax({
                        ...
                        data: <?php echo json_encode(array_merge(
                            ...
                            array(
                                'action' => 'extern',
                                'function' => 'MetroShippingDetailsProcessor::shippingConfig',
                                'kind' => 'ajax',
                                'func' => 'addRow',
                            )
                        )); ?>,
