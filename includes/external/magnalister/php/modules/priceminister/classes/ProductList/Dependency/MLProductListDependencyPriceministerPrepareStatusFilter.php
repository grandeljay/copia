...
class MLProductListDependencyPriceministerPrepareStatusFilter extends MLProductListDependencyPrepareStatusFilter {
	...
	protected function getPrepareTable() {
		return TABLE_MAGNA_PRICEMINISTER_PREPARE;
	}
