...
defined('TABLE_MAGNA_PRICEMINISTER_VARIANTMATCHING') OR define('TABLE_MAGNA_PRICEMINISTER_VARIANTMATCHING', 'magnalister_priceminister_variantmatching');
...
class PriceministerVariationMatching extends VariationMatching
{
    protected function getAttributesMatchingHelper()
    {
        return PriceministerHelper::gi();
    }

    protected function getTopTenCategoriesHandler()
    {
        return new PriceministerTopTenCategories();
    }

    protected function getCategoryMatchingHandler()
    {
        return new PriceministerCategoryMatching();
    }
}
