<?php
/* -----------------------------------------------------------------------------------------
   $Id: freeamount.php 12439 2019-12-02 17:40:51Z GTB $   
  ...
  class freeamount {
    ...
    function __construct() {
      ...
      $this->num_zones = defined('MODULE_SHIPPING_FREEAMOUNT_NUMBER_ZONES') ? MODULE_SHIPPING_FREEAMOUNT_NUMBER_ZONES : '1';
