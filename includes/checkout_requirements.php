<?php
  ...
  /* --------------------------------------------------------------
   $Id: checkout_requirements.php 11561 2019-03-20 16:36:11Z GTB $
...
foreach (auto_include(DIR_FS_CATALOG . 'includes/extra/checkout/checkout_requirements/', 'php') as $file) {
    require_once($file);
}
