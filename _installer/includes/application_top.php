...
/* -----------------------------------------------------------------------------------------
   $Id: application_top.php 14148 2022-03-16 17:53:54Z GTB $
...
$current_domain   = 'NONSSL' === $request_type ? $http_domain : $https_domain;

// set the top level domains to delete
$current_domain_delete = 'NONSSL' === $request_type ? $http_domain_arr['delete'] : $https_domain_arr['delete'];
...
if (true === $upgrade && check_auth() === false) {
    show_auth();
}
