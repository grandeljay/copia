...
/* -----------------------------------------------------------------------------------------
   $Id: update.php 14250 2022-04-01 09:20:39Z GTB $
    ...
    switch ($_GET['action']) {
        ...
        case 'doupdate':
          // form
            ...
            if (
                (isset($_POST['action']) && $_POST['action'] == 'updatenow')
        ...
        case 'readdb':
          // form
            ...
            if (
                (isset($_POST['action']) && $_POST['action'] == 'backupnow')
        ...
        case 'restoredb':
          // form
            ...
            if (
                (isset($_POST['action']) && $_POST['action'] == 'restorenow' && isset($_POST['restore_file']))
