...
// Warning: Gambio 2.1 executes boxes.php in class context (uses $this)
...
// $_SESSION['billpay_onAfterProcess']
$billpaySmarty->assign('campaignText', billpayBase::EnsureString($_SESSION['billpay_onAfterProcess']['campaignText']));
